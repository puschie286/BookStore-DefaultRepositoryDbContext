...
````bash
Add-Migration Your_Migration_Name -Context BookStoreDbContext
````

Using EF Core command line tool;

````bash
dotnet ef migrations add Your_Migration_Name --context BookStoreDbContext
````
...
````bash
Add-Migration Your_Migration_Name -Context BookStoreTenantDbContext -OutputDir TenantMigrations
````

Using EF Core command line tool:

````bash
dotnet ef migrations add Your_Migration_Name --context BookStoreTenantDbContext --output-dir TenantMigrations
````
